...
OBSTACLE_COLORS = [
    (210, 55, 55), (55, 170, 55), (210, 130, 50),
    (160, 55, 170), (50, 100, 200), (180, 170, 50)
]
...
class Pothole:
    ...
    def get_rect(self):
        return pg.Rect(self.x - self.RADIUS, self.y - self.RADIUS // 2, self.RADIUS * 2, self.RADIUS)
...
class OilSlick:
    ...
    def draw(self, surface):
        ...
        c0 = (
            ...
            clamp(int(60 + 40 * math.sin(t + 4.2)), 0, 255),
            190
        )
        c1 = (
            clamp(int(180 + 40 * math.sin(t + 1.0)), 0, 255),
            clamp(int(60 + 40 * math.sin(t + 3.1)), 0, 255),
            clamp(int(200 + 40 * math.sin(t + 5.2)), 0, 255),
            160
        )
...
class ObstacleCar:
    ...
    def __init__(self, lane, speed):
        ...
        if key not in ObstacleCar._cache:
            ...
            draw_car(s, 4, 4, self.width, self.height, self.color, WHITE, self.car_type)
...
class Road:
    ...
    def _build_base(self):
        ...
        for _ in range(180):
            ...
            pg.draw.rect(grass, col, (gx, gy, rng.randint(2, 5), rng.randint(3, 7)))
...
class HUD:
    ...
    def draw(self, surface, score, level, speed_pct, difficulty, multiplier, lives):
        ...
        if multiplier > 1.0:
            ...
            self._blit(f"x{multiplier:.1f} combo!", col, 14, 118, tiny=True)
...
class Game:
    ...
    def _prerender_blur_lines(self):
        ...
        for i in range(18):
            ...
            pg.draw.line(self._blur_lines, (255, 255, 255, 6), (lx, 0), (lx, HEIGHT), 1)
    ...
    def _update(self, dt):
        ...
        self.road.update(dt)
        target_blur = clamp((self.scroll_speed - 300) / 400 * 120, 0, 110)
